  ...
  return (
    <div className='navbar'>
      ...
      <ul className='nav-menu'>
        ...
        <li onClick={() => {setMenu("quiz")}}><Link style={{ textDecoration: 'none' }} to='/quiz'>Take quiz</Link> {menu === "quiz" ? <hr /> : <></>}  </li>
        {/* <li><Link to="/quiz">Take Quiz</Link></li> */}
      </ul>
      <div className='nav-login-cart'>
        <Link to='/login'><button>Login</button></Link>
        <Link to='/cart'><img  src={cart_icon} width="40px " height="40px "alt="" /> </Link>
